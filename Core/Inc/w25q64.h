...
/**
  *  W25Q64 Configuration
  */
#define W25Q_FLASH_SIZE                  0x800000  // 8MBits => 1MBytes
#define W25Q_BLOCK_SIZE                  0x10000   /* 64x1024 - 256 sectors of 64KBytes */
#define W25Q_BLOCK_SIZE                  0x10000   /* 64 KBytes */
#define W25Q_SECTOR_SIZE                 0x1000    /* 4 KBytes */
...
/**
 *  W25Q64 Commands W25Q Chip's Commands
 */
...
HAL_StatusTypeDef W25Q64_OSPI_WriteDisable(OSPI_HandleTypeDef* hospi);
...
HAL_StatusTypeDef W25Q64_OSPI_Erase_Block_32KB(OSPI_HandleTypeDef* hospi, uint32_t BlockAddress);
HAL_StatusTypeDef W25Q64_OSPI_Erase_Block_64KB(OSPI_HandleTypeDef* hospi, uint32_t BlockAddress);
